...
window.needToPreloadSounds = [
  ...
  {
    src: 'starry-night-0.mp3',
    id: 'sn-0'
  },
  {
    src: 'starry-night-1.mp3',
    id: 'sn-1',
  },
  {
    src: 'connection.mp3',
...
function startGame(key, onEndGame) {
  ...
  setTimeout(function() {
    guideStartLoopingAudio('c');
  }, 500);
  gameContainer.onEndGame = onEndGame;
  guideStopAllSoundsFade(500);
}
...
function startDialog() {
  ...
  Guide.event(new Action(function(e) {
    setTimeout(e, 500);
    guidePlayAudioFromId('tq-0', false, 0.25, function() {
      guideStartLoopingAudio('tq-1');
    }).s.start();
  }));
  ...
  function action_continueNotChicken() {
    ...
    Guide.event(new Interactability(true));
    Guide.event(new Action(function(e) {
      guidePlayAudioFromId('sn-0', false, 0.25, function() {
        guideStartLoopingAudio('sn-1');
      }).s.start();
      e();
    }));
...
function event_render87ARS_ACTIVITY_COMPLETE() {
  ...
  Guide.event(new Interactability(true));
  Guide.event(new Action(function(e) {
    guideStartLoopingAudioFade('sn-1');
    e();
  }));
